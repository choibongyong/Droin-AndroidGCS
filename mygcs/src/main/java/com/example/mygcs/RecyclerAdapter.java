...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder>{
    ...
    public RecyclerAdapter(ArrayList<SingerItem> bundle){
    ...
    public RecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View itemView = inflater.inflate(R.layout.send_message_item,  viewGroup, false);//viewGroup는 각각의 아이템을 위해서 정의한 xml레이아웃의 최상위 레이아우싱다.
    ...
    public void onBindViewHolder(@NonNull RecyclerAdapter.ViewHolder viewHolder, int i) {
        SingerItem message = messageBundle.get(i); //리사이클러뷰에서 몇번쨰게 지금 보여야되는시점이다 알려주기위해
